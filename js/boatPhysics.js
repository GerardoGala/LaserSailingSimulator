...
export function runBoatPhysics(boat, env) {
  // Read wind from UI

  const currentWindSpeed = env.windSpeed ?? 10;
  const currentWindShift = env.windDirection ?? 0;
  ...
  // Controls
  const outhaulVal = env.outhaul ?? 0;
